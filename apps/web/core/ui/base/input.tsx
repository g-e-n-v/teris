...
export const variants = tv({
  ...
  slots: {
    ...
    input: "h-full min-w-0 flex-1 bg-transparent outline-none",
    root: "relative flex w-full items-center gap-2",
  },
  variants: {
    size: {
    ...
    unstyled: {
      false: {
        ...
        root: [
          ...
          "rounded-lg border border-neutral-200 bg-white px-2 text-neutral-900 transition-all",
          "shadow-xs/5",
